...
/*
  if (random(1,3)==2) {
    red = map(random(0,255), 0, 255, 3, 5) * 64 - 1; 
  }
  if (random(1,3)==2) {
    green = map(random(0,255), 0, 255, 3, 5) * 64 - 1; 
  }
  if (random(1,6)==2) {
    blue = map(random(0,255), 0, 255, 3, 5) * 64 - 1; 
  }
...
void lightIfNeeded(boolean active, int pin){
  if (active) {
    if (millis()-startLight > 600){
      //  int light = map(random(0,255), 0, 255, 2, 8) * 32 - 1; 
